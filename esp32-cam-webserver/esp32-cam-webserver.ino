...
#include "time.h"
#include "driver/ledc.h"  // Asegúrate de que esta línea esté al inicio
#include "driver/periph_ctrl.h"
#include <ESPmDNS.h>

esp_task_wdt_config_t twdt_config = {
    .timeout_ms = 3000,  // 3 segundos (o el valor que necesites)
    .idle_core_mask = 0, // Aplicar a todos los núcleos
    .trigger_panic = true
};
 ...
 * an accesspoint called "SpikeyVision" (password: "HOLA1234")
 *
 */
...
// Primary config, or defaults.
    ...
    stationList[] = {{"SpikeyVision","HOLA1234", true}};
#endif
...
void setLamp(int newVal) {
    ...
    if (newVal != -1) {
        ...
        ledc_channel_config_t ledc_channel = {
            .gpio_num = LAMP_PIN,
            .speed_mode = LEDC_HIGH_SPEED_MODE,
            .channel = (ledc_channel_t)lampChannel,
...
void StartCamera() {
    ...
    if (err != ESP_OK) {
        ...
        // Note: periph_module_* functions are no longer available in ESP-IDF 5.x
        // Instead just use a watchdog to force a reset
